  ...
  return (
    <div dir="rtl" className="w-full p-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="rounded-2xl p-8 grid lg:grid-cols-4 gap-6 relative bg-muted">
          <div>
