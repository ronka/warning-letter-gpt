...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "אמנם השירות שלנו מספק דרך נוחה ומהירה ליצור תבנית למכתב אזהרה, אין זהו מכתב התראה משפוטי. אך במידה ואתה זקוק לייעוץ משפטי מעמיק או חותמת של עורך דין על המסמך, מומלץ להתייעץ עם עורך דין.",
  },
  {
